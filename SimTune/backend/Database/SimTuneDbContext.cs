...
public class SimTuneDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Exercise>().HasData(
            ...
            new Exercise {ExerciseId = 29, Description = "Bestimme die Tonleiter,dur und natürliches moll", Values = "Dur,Natürliches Moll", ExerciseType = ExerciseType.Tonleitern},
            new Exercise {ExerciseId = 30, Description = "Bestimme die Tonleiter,dur und moll", Values = "Dur,Natürliches Moll", ExerciseType = ExerciseType.Tonleitern},
            new Exercise {ExerciseId = 31, Description = "Bestimme die Tonleiter,dur & moll und natürliches moll", Values = "Dur,Natürliches Moll", ExerciseType = ExerciseType.Tonleitern}
        );
